...
<html lang="en-us" ng-app="gpsApp">
	...
	-->
	<body class=""  ng-controller="GpsListController as gpsList">
										...
										<table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
											<thead>
												<tr>
													...
													<th data-hide="phone,tablet">imei</th>
													<th data-hide="phone,tablet">Numero</th>
													<th data-hide="phone,tablet">Sim</th>
												</tr>
											</thead>
											<tbody>
												<tr ng-repeat="item in gpsList.devices.items">
													<td>{{$index}}</td>
													<td>{{item.id}}</td>
													<td>{{item.name}}</td>
													<td>{{item.online}}</td>
													<td>{{item.device_data.imei}}</td>
												<td>{{item.device_data.registration_number}}</td>
		...
		<script type="text/javascript">
			...
			angular.module('gpsApp', [])
			  .controller('GpsListController', function($http) {
			    var gpsList = this;
			    gpsList.gpss = [
			      {text:'learn AngularJS', done:true},
			      {text:'build an AngularJS app', done:false}];
			 
			    gpsList.addGps = function() {
			      gpsList.gpss.push({text:gpsList.gpsText, done:false});
			      gpsList.gpsText = '';
			    };

			    $http.get('https://web.smartgps.com.br/api/get_devices_latest?user_api_hash=$2y$10$yqP4ZJ06VieeWGPiEhNx5.tELC7lRfkv8bYLLjdmhdsfvQFg9OlWu').then(
			        function (response) { 
			            gpsList.devices = response.data
			        },
